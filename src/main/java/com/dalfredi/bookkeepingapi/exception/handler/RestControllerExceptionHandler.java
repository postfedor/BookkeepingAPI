...
import com.dalfredi.bookkeepingapi.exception.BadRequestException;
...
import com.dalfredi.bookkeepingapi.payload.api.ExceptionResponse;
...
public class RestControllerExceptionHandler {
    ...
    public ResponseEntity<ExceptionResponse> resolveException(
        ...
        return new ResponseEntity<>(new ExceptionResponse(messages,
    ...
    public ResponseEntity<ExceptionResponse> resolveException(
        ...
        String message =
            "Parameter '" + ex.getParameter().getParameterName() + "' must be '"
